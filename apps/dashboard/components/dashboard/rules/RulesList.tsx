...
const RulesList = () => {
  ...
  return (
    <div className="max-w-5xl w-full flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
        {rules.length === 0 ? (
          <div className="col-span-full">
            <div className="bg-[#101012] border border-white/[0.07] rounded-lg p-8 flex items-center justify-center min-h-[200px]">
      ...
      {/* Modals */}
      <CreateRuleModal isOpen={isModalOpen} onClose={handleCreateModalClose} />
      <UpdateRuleModal
        isOpen={!!editingRule}
